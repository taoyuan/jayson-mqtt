 ...
 *  @param {Object|String} mqttclient The mqtt.js client or connection url or connect options.
...
function MQTTServer(server, mqttclient, options) {
	...
	this.adapter = mqtt.connect(mqttclient, options);
...
MQTTServer.prototype.format = function (fmt) {
